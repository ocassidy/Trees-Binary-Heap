 ...
 * BinaryHeap.h
 *
 * Generic Dynamic BinaryHeap (Min Heap) based on array
 *
...
/**
* Find the next item in the heap.
...
/**
 *  Delete smallest (top) element in the heap
 */
template <class T>
...
/**
 * Add element to the heap, maintining min heap order property
 */
template <class T>
